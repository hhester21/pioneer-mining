            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleEmailSubmit} className="space-y-4">
                  ...
                  >
                    {isSubmitting ? "Submitting..." : "Get Investment Information"}
                  </Button>
                </form>
              </CardContent>
            </Card>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center space-y-4">
                    ...
                    <h3 className="text-lg font-semibold">Information Sent!</h3>
                    <p className="text-slate-600">
                      We've sent detailed investment information to <strong>{email}</strong>
                    </p>
                    <p className="text-sm text-slate-500">
                      Our investment team will also reach out within 24 hours to discuss this opportunity.
                    </p>
                    <div className="pt-4">
